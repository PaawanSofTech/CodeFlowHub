...
// ─── Objects (sync protocol) ─────────────────────────────────────────────────
export const objectsApi = {
  head: (owner: string, name: string) =>
    api.get(`/api/repos/${owner}/${name}/objects/head`).then(r => r.data),
  list: (owner: string, name: string) =>
    api.get(`/api/repos/${owner}/${name}/objects/list`).then(r => r.data),
}
